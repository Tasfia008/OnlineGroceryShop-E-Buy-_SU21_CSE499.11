...
?>
    ...
    global.onload = function () {
		noBackPlease();
		// disables backspace on page except on input fields
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Maliha</h5>
															<p class="date">2 DEC 2019, 8:0 PM</p>
														...
														<div class="review-body">
															<p>A very good service.</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Zim</h5>
															<p class="date">21 DEC 2019, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Well satisfactory.</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Antor</h5>
															<p class="date">22 DEC 2019, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Very fast delivery and fresh product.</p>
														</div>
													</li>
												</ul>
