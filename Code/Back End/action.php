...
//for searching if category or brand or keyword matched
   ...
   //adding to cart
	if (isset($_POST["addToCart"])) {
		...
		if ($count > 0) {
			...
			//adding product info to the cart
			$sql = "INSERT INTO `cart`
			(`p_id`, `ip_add`, `user_id`, `qty`)
			VALUES ('$p_id','$ip_add','$user_id','1')";
			//checking connetivity
              ...
              ';
				...
				<tfoot>
					<tr>
						...
						<td class="hidden-xs text-center"><b class="total" ></b></td>
