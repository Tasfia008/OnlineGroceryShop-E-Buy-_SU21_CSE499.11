			...
			<div id = "top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						<li><a href="#"><i class="fa fa-bdt"></i>TK</a></li>
						<li>
							<?php
				                 // connecting database
                         include "db.php";
                               ...
                               <div class="dropdownn">
                                  ...
                                  <div class="dropdownn-content">
                                    <a href="" data-toggle="modal" data-target="#profile"><i class="fa fa-user-circle" aria-hidden="true" ></i>My Profile</a>
																		<a href="" data-toggle="modal" data-target="#profile"><i class="fa fa-user-circle" aria-hidden="true" ></i>My Order</a>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
								<font style="font-style:normal; font-size: 25px;color: aliceblue;font-family: serif">
                                        Online Grocery Shop
                                    </font>
								</a>
							</div>
